  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-between p-8">
      ...
      <div className="flex flex-col items-center mb-16 pointer-events-auto">
        <p className="text-arix-pale/70 font-sans text-sm mb-8 max-w-md text-center leading-relaxed">
          {isTree 
            ? "A collection of cute, precious moments stacked into a festive form." 
            : "Wishes and dreams floating in the winter sky. Gather them together."}
        </p>
        ...
        >
          <div className="flex items-center gap-3">
             {isTree ? (
               <Sparkles className="w-5 h-5 text-arix-gold group-hover:spin-slow" />
             ) : (
      ...
      {/* Footer */}
      <div className="absolute bottom-6 right-8 text-right opacity-50">
        <p className="text-[10px] text-arix-pale font-sans tracking-widest">ARIX HOLIDAY EDITION</p>
      </div>
    </div>
  );
};
